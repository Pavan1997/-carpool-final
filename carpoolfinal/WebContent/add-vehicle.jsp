                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-xs-12">
                        ...
                        <div class="page-content add-new-ride">
                            ...
                            <form action="VehicleServlet" method = "post" novalidate autocomplete="off" class="idealforms add-ride">
                                ...
                                <input type="text" id="NumberOfSeats" name="NumberOfSeats" placeholder="Number of seats">
                                <input type="text" id="PricePerKm" name="PricePerKm" placeholder="Price per Km">
                                </div>
